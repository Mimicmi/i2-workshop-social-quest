            ...
            <div className="timeline">
                <div className="timeline__event  animated fadeInUp delay-3s timeline__event--type1">
                    ...
                    <div className="timeline__event__content ">
                        ...
                        <div className="timeline__event__description">
                            <p>
                                Dans ce jeu, tu sera un forgeron numérique dont
                                la mission est de créer des mots de passe
                                incassables pour protéger des trésors virtuels.
                                À chaque niveau, tu rencontrera différents types
                                de "hackers" qui essaient de déchiffrer des mots
                                de passe. Tu pourras combiner des caractères
                                spéciaux, des chiffres, des majuscules, et des
                                mots aléatoires pour créer des mots de passe
                                solides qui résistent aux attaques.
                            </p>
                        </div>
                    </div>
                </div>
                <div className="timeline__event  animated fadeInUp delay-3s timeline__event--type2">
                    ...
                    <div className="timeline__event__content ">
                        ...
                        <div className="timeline__event__description">
                            <p>
                                Dans ce jeu, tu es chargés de créer et de gérer
                ...
                <div className="timeline__event animated fadeInUp delay-2s timeline__event--type3">
                    ...
                    <div className="timeline__event__content">
                        ...
                        <div className="timeline__event__description">
                            <p>
                                Découvre comment protéger ton profil en ligne en
                                ajustant correctement les paramètres de sécurité
                                de ton compte. Tu devras te défendre contre des
                                vagues d'intrusions en configurant des mots de
                                passe robustes, en activant l'authentification à
                                deux facteurs, et en bloquant les comptes
                                suspects. Chaque niveau enseigne des astuces de
                                sécurité qui renforcent la forteresse de ton
                                identité en ligne.
                            </p>
                        </div>
                    </div>
                ...
                <div className="timeline__event animated fadeInUp delay-1s timeline__event--type1">
                    ...
                    <div className="timeline__event__content">
                        ...
                        <div className="timeline__event__description">
                            <p>
                                Dans ce jeu de gestion du temps, tu vas devoir
                                équilibrer leur journée en alternant entre les
                                réseaux sociaux et d'autres activités (école,
                                sports, sommeil). Tu découvres comment un temps
                                d'écran excessif affecte ton bien-être général.
                                L’objectif est de maintenir un équilibre en
                                maintenant une barre de santé stable.
                            </p>
                        </div>
                    </div>
                </div>
                <div className="timeline__event  animated fadeInUp delay-3s timeline__event--type2">
                    ...
                    <div className="timeline__event__content ">
                        ...
                        <div className="timeline__event__description">
                            <p>
                                Sur les réseaux, tout le monde n’est pas ton
                ...
                <div className="timeline__event  animated fadeInUp delay-3s timeline__event--type3">
                    ...
                    <div className="timeline__event__content">
                        ...
                        <div className="timeline__event__description">
                            <p>
                                Dans ce jeu, tu vas prendre le rôle de créateurs
                ...
                <div className="timeline__event animated fadeInUp delay-2s timeline__event--type1">
                    ...
                    <div className="timeline__event__content">
                        <div className="timeline__event__title">Impact</div>
                        <div className="timeline__event__description">
                            <p>
                                Dans ce jeu, tu vas naviguer dans un monde
                    ...
                    <div className="timeline__event__content ">
                        ...
                        <div className="timeline__event__description">
                            <p>
                                ...
                                identifier les arnaques des vraies messages et
                                ainsi passer ce module aisément.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="timeline__event animated fadeInUp delay-2s timeline__event--type1">
                    ...
                    <div className="timeline__event__content">
                        ...
                        <div className="timeline__event__description">
                            <p>
                                Tu vas incarner un super-héros du web qui combat
                ...
                >
                    ...
                    <div className="timeline__event__content">
                        ...
                        <div className="timeline__event__description">
                            <p>
                                Dans ce jeu, tu incarnes un détective numérique
                                chargé de repérer des vidéos manipulées, connues
                                sous le nom de "deepfakes". Ils se retrouvent
                                dans une salle de contrôle où différentes vidéos
                                sont projetées sur des écrans. À l’aide
                                d’indices et d’outils d’analyse, tu devras
                                examiner les vidéos pour détecter des signes de
                                manipulation, tels que des mouvements de lèvres
                                incohérents, des ombres anormales ou des
                                expressions faciales qui semblent irréelles.
                            </p>
                        </div>
                    </div>
                </div>
